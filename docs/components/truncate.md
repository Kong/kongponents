...
<KCard>
  <KTruncate text-content :rows="2" width="50%">
...
- `truncatedCount` (type: `Number`) - Number of elements that overflow. **Note**: this slot prop is only available when not `textContent`
