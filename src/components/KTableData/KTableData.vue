...
const sortColumnKey = ref(initialFetcherParams.sortColumnKey || tablePreferences.sortColumnKey || '') as Ref<ColumnKey>
const sortColumnOrder = ref<SortColumnOrder>(initialFetcherParams.sortColumnOrder || tablePreferences.sortColumnOrder || 'desc')
