...
input.k-input + .hint {
  ...
  color: var(--tblack-45, color(tblack-45));
}
</style>
...
input {
  ...
  color: var(--KInputColor, var(--tblack-70, color(tblack-70)));
  ...
  &:focus {
    ...
    border: 1px solid var(--KInputFocus, var(--blue-light, color(blue-light)));
  }

  &:disabled {
    cursor: not-allowed;
    font-style: italic;
    background-color: var(--KInputDisabledBackground, var(--grey-98, color(grey-88)));
    opacity: 0.5;
  }
  ...
  &.input-error {
    outline: none !important;
    border: 1px solid var(--KInputError, var(--red-light, color(red-light)));
  }
