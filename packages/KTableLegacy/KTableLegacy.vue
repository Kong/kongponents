...
.k-table.k-table-legacy {
  ...
  thead {
    border-top: 1px solid var(--KTableLegacyBorder, var(--grey-200, color(grey-200)));
    border-bottom: 2px solid var(--KTableLegacyBorder, var(--grey-200, color(grey-200)));
    th {
      padding: var(--spacing-sm, spacing(sm)) var(--spacing-md, spacing(md));
      text-align: left;
      font-size: var(--KTableLegacyHeaderSize, var(--type-sm, type(sm)));
      font-weight: 500;
      .sr-only {
        position: absolute;
        width: 1px;
  ...
  tbody {
    tr {
      border-bottom: 1px solid var(--KTableLegacyBorder, var(--grey92, color(grey-200)));
    }
    td {
      color: var(--KTableLegacyColor, var(--black-70, color(black-70)));
      a {
  ...
  &.has-hover tbody tr:hover {
    background-color: var(--KTableLegacyHover, var(--steel-100, color(steel-100)));
  }
  &.is-clickable {
    cursor: pointer;
  ...
  &.side-border {
    ...
    tbody tr {
      border: none;
      box-shadow: -2px 0 0 var(--KTableLegacyBorder, var(--steel-200, color(steel-200)));
    }
    &.has-hover {
      tbody tr:hover {
        box-shadow: -2px 0 0 var(--KTableLegacyBorder, var(--steel-300, color(steel-300)));
      }
    }
  }
}
