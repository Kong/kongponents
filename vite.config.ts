...
export default defineConfig({
  plugins: [
    vue(),
    ...(process.env.DISABLE_VUE_DEVTOOLS ? [] : [VueDevTools()]), // Cypress 14+ introduces an issue with VueDevTools when running tests so we need to disable it in the test environment only
  ],
  resolve: {
    alias: {
